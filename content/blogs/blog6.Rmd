...
The first thing I is to tidy the data, as it is in wide format and you must make it into long, tidy format, and express all figures in billions (divide values by `1e9`, or $10^9$), and rename the indicators into something shorter.
...
Secondly, recall that GDP is the sum of Household Expenditure (Consumption *C*), Gross Capital Formation (business investment *I*), Government Expenditure (G) and Net Exports (exports - imports). Even though there is an indicator `Gross Domestic Product (GDP)` in dataframe, I would like  to calculate it given its components discussed above.



```{r gdp2_rep, fig.width='100%'}
library(scales)
